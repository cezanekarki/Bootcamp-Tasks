...
rxnconso_sheet_name = 'RXNSAT'

headers = pd.read_excel(file_location, sheet_name=rxnconso_sheet_name, usecols=[1], header=None).iloc[:, 0].tolist()
print (headers)

rxnconso_file_location = os.path.abspath(r"C:\Users\upsal\Downloads\RXNORM\rrf\RXNSAT.RRF")
...
output_csv_path = r"C:\Users\upsal\Downloads\RXNORM\rrf\rxnsat_processed.csv"
