...
# MAGIC %md
# MAGIC ###changing sales_data (transaction_date) and employee_sales_data (sale_date) to date format
...
# MAGIC %md
# MAGIC ###Joining sales_data with products_data using product_id as key
