...
select trainer_name,sum(training_session_duration_hours) as sum,avg(training_session_duration_hours) as avg,min(training_session_duration_hours)as min ,max(training_session_duration_hours) as max from training_data group by 1;

-- COMMAND ----------

select trainer_name,participant_id ,sum(training_session_duration_hours) as sum,avg(training_session_duration_hours) as avg,min(training_session_duration_hours)as min ,max(training_session_duration_hours) as max from training_data group by 1,2;

-- COMMAND ----------

select trainer_name ,sum(training_session_duration_hours) as sum,avg(training_session_duration_hours) as avg,min(training_session_duration_hours)as min ,max(training_session_duration_hours) as max from training_data group by 1 having avg >2;

-- COMMAND ----------

select trainer_name, count(*) as ct from training_data group by trainer_name having ct >2
