...
-- MAGIC file_location = "/FileStore/tables/contactinfo.txt"
-- MAGIC file_type = "csv"
-- MAGIC
-- MAGIC # CSV options
...
-- MAGIC
-- MAGIC temp_table_name = "contactinfo_txt_new"
-- MAGIC
...
select * from `contactinfo_txt_new`
...
-- MAGIC
-- MAGIC permanent_table_name = "contactinfo1_txt_new"
-- MAGIC
