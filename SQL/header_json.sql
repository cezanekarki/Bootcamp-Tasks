...
-- MAGIC file_location = "/FileStore/tables/header.json"
...
-- MAGIC
-- MAGIC temp_table_name = "header_json_new"
-- MAGIC
...
-- MAGIC
-- MAGIC permanent_table_name = "header1_json_new"
-- MAGIC
