...
def months_and_weeks_passed(birthdate):
    ...
    months_passed = delta.days 
    weeks_passed = delta.days
...
string_json = '{"name": "John Doe", "dob": "1990-01-01 00:00:00", "city": "Anytown", "email": "john.doe@example.com", "is_student": false}'
...
read_file['dob'] = datetime.strptime(read_file['dob'], '%Y-%m-%d %H:%M:%S')
